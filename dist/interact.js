...
/*
    if (originalEdges.top && originalEdges.left ||
        originalEdges.bottom && originalEdges.right ||
        originalEdges.right) {
        negativeSecondaryEdge = false;
        state.xIsPrimaryAxis = true
    }

    if (originalEdges.top && originalEdges.right ||
        originalEdges.bottom && originalEdges.left) {
        negativeSecondaryEdge = true;
        state.xIsPrimaryAxis = false
    }

    if (originalEdges.left) {
        negativeSecondaryEdge = false;
        state.xIsPrimaryAxis = true
    }

    if (originalEdges.top ||
        originalEdges.bottom) {
        negativeSecondaryEdge = false;
        state.xIsPrimaryAxis = false
    }
*/
